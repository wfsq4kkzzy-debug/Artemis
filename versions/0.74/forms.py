...
# Lazy import pro UctovaSkupina - importuje se až v __init__
def get_uctova_skupina():
    from modules.budget.models import UctovaSkupina
    return UctovaSkupina
...
class NovaRozpoctovaPolozkaBez(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        UctovaSkupina = get_uctova_skupina()
        from core import db
